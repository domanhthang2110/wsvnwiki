...
export default function AdminPostsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-4 dark:text-gray-100">
        ...
        <div className="mt-8">
          ...
          {posts.length > 0 && (
            <ul className="space-y-2">
              {posts.map(post => (
                <li key={post.id} className="p-3 border rounded-lg dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm flex justify-between items-center transition-shadow hover:shadow-md">
